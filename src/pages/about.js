...
export async function render() {
  ...
  page.innerHTML = `
    ...
    <div class="config-section">
      <div class="config-section-title">苍洱API</div>
      <div style="font-size:var(--font-size-sm);color:var(--text-secondary);line-height:1.6">
        <p>AI 模型 API 中转平台，支持 OpenAI 和 Anthropic 全系列模型。</p>
        <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:12px">
          <a class="btn btn-primary btn-sm" href="https://api.772.ee/" target="_blank" rel="noopener">苍洱API 官网</a>
        </div>
      </div>
    </div>
